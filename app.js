 ...
 */const s=new WeakMap,i=t=>"function"==typeof t&&s.has(t),n=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,r=(t,e,s=null,i=null)=>{for(;e!==s;){const s=e.nextSibling;t.insertBefore(e,i),e=s}},o=(t,e,s=null)=>{for(;e!==s;){const s=e.nextSibling;t.removeChild(e),e=s}},a={},l={},c=`{{lit-${String(Math.random()).slice(2)}}}`,h=`\x3c!--${c}--\x3e`,d=new RegExp(`${c}|${h}`),u="$lit$";class p{constructor(t,e){this.parts=[],this.element=e;const s=[],i=[],n=document.createTreeWalker(e.content,133,null,!1);let r=0,o=-1,a=0;const{strings:l,values:{length:h}}=t;for(;a<h;){const t=n.nextNode();if(null!==t){if(o++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:s}=e;let i=0;for(let t=0;t<s;t++)f(e[t].name,u)&&i++;for(;i-- >0;){const e=l[a],s=_.exec(e)[2],i=s.toLowerCase()+u,n=t.getAttribute(i);t.removeAttribute(i);const r=n.split(d);this.parts.push({type:"attribute",index:o,name:s,strings:r}),a+=r.length-1}}"TEMPLATE"===t.tagName&&(i.push(t),n.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(c)>=0){const i=t.parentNode,n=e.split(d),r=n.length-1;for(let e=0;e<r;e++){let s,r=n[e];if(""===r)s=m();else{const t=_.exec(r);null!==t&&f(t[2],u)&&(r=r.slice(0,t.index)+t[1]+t[2].slice(0,-u.length)+t[3]),s=document.createTextNode(r)}i.insertBefore(s,t),this.parts.push({type:"node",index:++o})}""===n[r]?(i.insertBefore(m(),t),s.push(t)):t.data=n[r],a+=r}}else if(8===t.nodeType)if(t.data===c){const e=t.parentNode;null!==t.previousSibling&&o!==r||(o++,e.insertBefore(m(),t)),r=o,this.parts.push({type:"node",index:o}),null===t.nextSibling?t.data="":(s.push(t),o--),a++}else{let e=-1;for(;-1!==(e=t.data.indexOf(c,e+1));)this.parts.push({type:"node",index:-1}),a++}}else n.currentNode=i.pop()}for(const t of s)t.parentNode.removeChild(t)}}const f=(t,e)=>{const s=t.length-e.length;return s>=0&&t.slice(s)===e},g=t=>-1!==t.index,m=()=>document.createComment(""),_=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const k=new class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new A(t,e.slice(1),s).parts}return"@"===n?[new V(t,e.slice(1),i.eventContext)]:"?"===n?[new T(t,e.slice(1),s)]:new P(t,e,s).parts}handleTextExpression(t){return new N(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function O(t){let e=U.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},U.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const i=t.strings.join(c);return void 0===(s=e.keyString.get(i))&&(s=new p(t,t.getTemplateElement()),e.keyString.set(i,s)),e.stringsArray.set(t.strings,s),s}const U=new Map,$=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const j=(t,...e)=>new S(t,e,"html",k),M=(t,...e)=>new w(t,e,"svg",k),z=133;function q(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,z,null,!1);let r=B(i),o=i[r],a=-1,l=0;const c=[];let h=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===h&&(h=null),e.has(t)&&(c.push(t),null===h&&(h=t)),null!==h&&l++;void 0!==o&&o.index===a;)o.index=null!==h?-1:o.index-l,o=i[r=B(i,r)]}c.forEach(t=>t.parentNode.removeChild(t))}const I=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,z,null,!1);for(;s.nextNode();)e++;return e},B=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(g(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
			...
			${this.card?bt({screen:j`
						...
						`,topLeftLed:j`
							...
							<input
								id="topLeftLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){if(t.target){const e=wt(t.target.value);yield this.card.topLeftLed.write(e)}}))}
							/>
						`,topRightLed:j`
							...
							<input
								id="topRightLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){if(t.target){const e=wt(t.target.value);yield this.card.topRightLed.write(e)}}))}
							/>
						`,bottomLeftLed:j`
							...
							<input
								id="bottomLeftLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){if(t.target){const e=wt(t.target.value);yield this.card.bottomLeftLed.write(e)}}))}
							/>
						`,bottomRightLed:j`
							...
							<input
								id="bottomRightLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){if(t.target){const e=wt(t.target.value);yield this.card.bottomRightLed.write(e)}}))}
							/>
						`}):bt({screen:j`
							<button @click=${this.connect}>connect</button>
						`})}
		`}connect(){return e(this,void 0,void 0,(function*(){try{this.clearError(),this.card=yield function(){return e(this,void 0,void 0,(function*(){console.log("Requesting Bluetooth Device...");const t=yield navigator.bluetooth.requestDevice({filters:[{services:[yt]},{namePrefix:"card10"}],optionalServices:[yt,"battery_service"]});if(console.log("Connected to:"+t.name),console.log("Connecting to GATT Server..."),!t.gatt)throw Error("no gatt server available");const e=yield t.gatt.connect();console.log("Getting Service...");const s=yield e.getPrimaryService(yt),i=new vt(s);return yield i.vibrate(100),console.log("BT initialized"),i}))}()}catch(t){this.error=t}}))}clearError(){this.error=""}}t([lt({type:String})],xt.prototype,"error",void 0),t([lt({attribute:!1})],xt.prototype,"card",void 0),St&&customElements.define("my-app",xt);
