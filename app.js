 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=` ${c} `;class S{constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",s=!1;for(let i=0;i<t;i++){const t=this.strings[i],n=t.lastIndexOf("\x3c!--");s=(n>-1||s)&&-1===t.indexOf("--\x3e",n+1);const r=v.exec(t);e+=null===r?t+(s?y:h):t.substr(0,r.index)+r[1]+r[2]+u+r[3]+c}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class w extends S{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,s=e.firstChild;return e.removeChild(s),r(e,s.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
			...
			${this.card?bt({screen:j`
						...
						`,topLeftLed:j`
							...
							<input
								id="topLeftLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=wt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.topLeftLed.write(s)}}))}
							/>
						`,topRightLed:j`
							...
							<input
								id="topRightLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=wt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.topRightLed.write(s)}}))}
							/>
						`,bottomLeftLed:j`
							...
							<input
								id="bottomLeftLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=wt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.bottomLeftLed.write(s)}}))}
							/>
						`,bottomRightLed:j`
							...
							<input
								id="bottomRightLed"
								type="color"
								@input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=wt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.bottomRightLed.write(s)}}))}
							/>
						`}):bt({screen:j`
