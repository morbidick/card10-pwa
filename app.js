...
const currentTimeAsBigEndian = () => {
    ...
    while (sourceI >= 0) {
        data[targetI] = parseInt(`${hexTime[sourceI - 1] || 0}${hexTime[sourceI]}`, 16);
        targetI = targetI - 1;
        sourceI = sourceI - 2;
    }
    return data;
...
class Card10 {
    constructor(service) {
        ...
        this.vibrate = numberCharacteristic(this.service, '4223020f-2342-2342-2342-234223422342').write;
        this.bottomLeftLed = rgbCharacteristic(this.service, '42230211-2342-2342-2342-234223422342');
        this.bottomRightLed = rgbCharacteristic(this.service, '42230212-2342-2342-2342-234223422342');
        this.topLeftLed = rgbCharacteristic(this.service, '42230213-2342-2342-2342-234223422342');
        this.topRightLed = rgbCharacteristic(this.service, '42230214-2342-2342-2342-234223422342');
        this.clock = timeCharacteristic(this.service, '42230201-2342-2342-2342-234223422342');
    }
}
function connect() {
...
], MyApp.prototype, "error", void 0);
__decorate([
    property({ attribute: false })
], MyApp.prototype, "card", void 0);
if (supported) {
