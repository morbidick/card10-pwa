...
`;class xt extends ft{constructor(){super(...arguments),this.error=""}static get styles(){return ut`*{box-sizing:border-box}svg{color:#888;width:100%}svg button,svg input{width:100%;height:100%;font:inherit}button.connect{font-size:2em}.rotate{display:block;transform:rotate(-90deg) translate(-50%)}label.hidden{display:block;width:0;height:0}`}render(){return j`${this.error?j`<div class=error>${this.error}</div>`:""} ${this.card?wt({screen:j`<button @click=${()=>{var t;null===(t=this.card)||void 0===t||t.clock.now()}}>Set current time</button>`,topLeftLed:j`<label class=hidden for=topLeftLed>set top left led color</label> <input id=topLeftLed type=color @input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=bt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.topLeftLed.write(s)}}))}>`,topRightLed:j`<label class=hidden for=topRightLed>set top right led color</label> <input id=topRightLed type=color @input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=bt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.topRightLed.write(s)}}))}>`,bottomLeftLed:j`<label class=hidden for=bottomLeftLed>set bottom left led color</label> <input id=bottomLeftLed type=color @input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=bt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.bottomLeftLed.write(s)}}))}>`,bottomRightLed:j`<label class=hidden for=bottomRightLed>set bottom right led color</label> <input id=bottomRightLed type=color @input=${t=>e(this,void 0,void 0,(function*(){var e;if(t.target){const s=bt(t.target.value);yield null===(e=this.card)||void 0===e?void 0:e.bottomRightLed.write(s)}}))}>`,vibrationMotor:j`<button @click=${()=>{var t;null===(t=this.card)||void 0===t||t.vibrate(1e3)}}><span class=rotate>vibrate</span></button>`}):wt({screen:j`<button class=connect @click=${this.connect}>connect</button>`})}`}connect(){return e(this,void 0,void 0,(function*(){try{this.clearError(),this.card=yield function(t=(()=>{})){return e(this,void 0,void 0,(function*(){console.log("Requesting Bluetooth Device...");const e=yield navigator.bluetooth.requestDevice({filters:[{services:[_t]},{namePrefix:"card10"}],optionalServices:[_t,"battery_service"]});if(console.log("Connected to:"+e.name),e.addEventListener("gattserverdisconnected",t),console.log("Connecting to GATT Server..."),!e.gatt)throw Error("no gatt server available");const s=yield e.gatt.connect();console.log("Getting Service...");const i=yield s.getPrimaryService(_t),n=new yt(i);return yield n.vibrate(100),console.log("BT initialized"),n}))}(()=>this.card=null)}catch(t){this.error=t}}))}clearError(){this.error=""}}t([lt({type:String})],xt.prototype,"error",void 0),t([lt({attribute:!1})],xt.prototype,"card",void 0),St&&customElements.define("my-app",xt);
//# sourceMappingURL=app.897d43d6.js.map
